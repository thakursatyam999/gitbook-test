...
* How to check the [Jenkins permissions and authentication requirements](jenkins-connector.md#before-you-begin) before you connect Harness to Jenkins.
* How to [add a Jenkins connector](jenkins-connector.md#add-a-jenkins-connector) to a Harness project so you can run Jenkins jobs from a pipeline.
...
8. Click **Finish** after the connection test succeeds.
